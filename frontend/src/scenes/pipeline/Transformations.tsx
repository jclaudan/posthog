...
import { newButton } from './utils'

export function Transformations(): JSX.Element {
    const { loading, sortedEnabledPluginConfigs, disabledPluginConfigs, plugins, canConfigurePlugins } =
            ...
            <LemonTable
                ...
                columns={[
                    ...
                    },
                    {
                        ...
                        render: function RenderAppInfo(_, pluginConfig) {
                            return renderApp(plugins[pluginConfig.plugin])
                        },
                    },
                    updatedAtColumn<PluginConfigTypeNew>() as LemonTableColumn<
                        PluginConfigTypeNew,
                        keyof PluginConfigTypeNew | undefined
                    >,
                    {
                        title: 'Status',
                                        ...
                                        <Tooltip
                                            title={
                                                <>
                                                    Click to see logs.
                                                    <br />
                                                    {humanFriendlyDetailedTime(pluginConfig.error.time)}:{' '}
                                            ...
                                            <LemonButton
                                                ...
                                                onClick={() => {
                                                    deleteWithUndo({
                                                        ...
                                                        object: { id: pluginConfig.id, name: pluginConfig.name },
                ...
                emptyState={
                    <ProductIntroduction
                        ...
                        actionElementOverride={newButton(PipelineTabs.Transformations)}
                        isEmpty={true}
                    />
                }
            />
...
function renderApp(plugin: PluginType): JSX.Element {
    return (
            ...
            <div>
                <div className="flex gap-2 items-center">
                    <span className="font-semibold truncate">
                        <Tooltip title={'Click to view app source code'}>
